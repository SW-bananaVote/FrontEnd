...
function Header() {
  ...
  return (
    <HeaderContainer>
      ...
      <CategoryArea>
        <CategoryButton><CategoryIcon src={news_icon} alt='News Icon'/> 뉴스</CategoryButton>
      </CategoryArea>
      <CategoryArea>
        <CategoryButton><CategoryIcon src={candidate_icon} alt='Category Icon'/> 후보자 정보</CategoryButton>
      </CategoryArea>
      <CategoryArea>
        <CategoryButton><CategoryIcon src={vote_icon} alt='Vote Icon'/> 선거 정보</CategoryButton>
      </CategoryArea>
      <LoginButtonArea>
